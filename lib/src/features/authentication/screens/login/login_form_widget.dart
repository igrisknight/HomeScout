        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Align(alignment: Alignment.centerRight, child: TextButton(onPressed: (){}, child: Text(hForgetPassword))),
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: (){}, child: Text(hLogin.toUpperCase()))),
            ],
          ),
        ));
  }
